...
The spin state is represented by the following, <img src="https://bit.ly/2Ns1fHi" align="center" border="0" alt="  \chi _{+}= \begin{bmatrix}1 \\0 \end{bmatrix}  " width="81" height="42" /> (spin up) and <img src="http://www.sciweavers.org/tex2img.php?eq=%20%20%5Cchi%20_%7B-%7D%3D%20%5Cbegin%7Bbmatrix%7D0%20%5C%5C1%20%5Cend%7Bbmatrix%7D%20%20&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=0" align="center" border="0" alt="  \chi _{-}= \begin{bmatrix}0 \\1 \end{bmatrix}  " width="81" height="42" /> (spin down). 
