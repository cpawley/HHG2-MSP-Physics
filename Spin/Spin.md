...
Then, the components of the eigenvectors need to be found using the following general formula: .Plugging in the operator Sx, we find that \alpha=\pm \bete. We are looking for probabilities, thus we know that equation. Therefore, equation.
