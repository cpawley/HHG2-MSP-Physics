...
The Cartesian or the fundamental coordinate system [📖](file:///Users/carlottamilone/Desktop/Schermata%202021-01-15%20alle%2014.44.26.png) is a powerful tool to accurately define position and thus help other quantities which rely on accurate initial measurements. So, we can use coordinate systems to accurately visualize and understand what function are and how they behave. 
...
Plotting on 1 dimension means only plotting on **one axis**, creating a number line. A number line assigns an origin (0) for reference and then positive and negative number on either side.  An example of its use is *plotting a motion* for example a person walking. <br>
...
The spherical coordinate system [📖](file:///Users/carlottamilone/Desktop/Schermata%202021-01-15%20alle%2014.44.26.png) describes a point in three-dimensional space. The position is described by three numbers: **radial distance (r), polar angle (θ) and azimuthal angle (φ)**. The spherical coordinate system is mostly used for solving problems that deal with spherical symmetry like gravity of a Planet.
...
The tables below include **Cylindrical coordinates**  [📖](file:///Users/carlottamilone/Desktop/Schermata%202021-01-15%20alle%2014.44.26.png)which were not previously mentioned. The concept is similar to the one of spherical coordinates.
...
**Table for conversion between unit vectors[📖](file:///Users/carlottamilone/Desktop/Schermata%202021-01-15%20alle%2014.44.26.png) in terms of destination coordinates**
...
To *process data found in experiments* one might want to use mathematical operations in order to analyse data. The del [📖](file:///Users/carlottamilone/Desktop/Schermata%202021-01-15%20alle%2014.44.26.png) formulas are incredibly usefull for analysing systems, but  their formulas differ for coordinate systems. Below is a table which has some of the formulas that are used frequently.
